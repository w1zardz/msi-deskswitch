...
Compress-Archive -LiteralPath (Join-Path $PSScriptRoot 'Configure-GoXlrStartup.cmd'), (Join-Path $PSScriptRoot 'Configure-GoXlrStartup.ps1'), (Join-Path $PSScriptRoot 'GoXlrStartupShortcut.cs') -DestinationPath $taskZip -Update

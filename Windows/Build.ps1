...
Compress-Archive -LiteralPath (Join-Path $PSScriptRoot 'Configure-GoXlrStartup.cmd'), (Join-Path $PSScriptRoot 'Configure-GoXlrStartup.ps1') -DestinationPath $taskZip -Update
